...
class GameTestCase:
    def __init__(self, root):
        ...
        self.setup_player_cards(self.game1.player1_hand, "player1", self.game_grid1.PLAYER1_HAND, self.game_grid1.PLAYER1_DECK)

        # Setup player 2 cards (repeat similar setup for player 2)
        self.setup_player_cards(self.game1.player2_hand, "player2", self.game_grid1.PLAYER2_HAND, self.game_grid1.PLAYER2_DECK)
